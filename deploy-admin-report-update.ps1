Write-Host "🚀 Deploying Admin Report Table Header Update..." -ForegroundColor Green
...
$sshCommand = "cd $FRONTEND_DIR && npm run build && pm2 restart sales-frontend && pm2 status && echo '✅ Admin Report table header update deployed successfully!'"
