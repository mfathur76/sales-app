/*
  ...
  - You are about to drop the column `cashBank` on the `outlet_sales` table. All the data in the column will be lost.
  - You are about to drop the column `cashPercent` on the `outlet_sales` table. All the data in the column will be lost.
...
INSERT INTO "new_outlet_sales" ("cash", "createdAt", "date", "gojek", "gojekBank", "gojekPercent", "grab", "grabBank", "grabPercent", "notes", "outlet", "overallPercent", "qris", "qrisBank", "qrisPercent", "shopee", "shopeeBank", "shopeePercent", "status", "totalBank", "totalSales", "updatedAt", "verifiedAt", "verifiedBy") SELECT "cash", "createdAt", "date", "gojek", "gojekBank", "gojekPercent", "grab", "grabBank", "grabPercent", "notes", "outlet", "overallPercent", "qris", "qrisBank", "qrisPercent", "shopee", "shopeeBank", "shopeePercent", "status", "totalBank", "totalSales", "updatedAt", "verifiedAt", "verifiedBy" FROM "outlet_sales";
